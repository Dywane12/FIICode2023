...
Revision ID: 9ce8a2c74aad
Revises: 1538025c4671
Create Date: 2023-03-15 13:39:32.778449
...
revision = '9ce8a2c74aad'
down_revision = '1538025c4671'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('state', sa.VARCHAR(length=256), nullable=False),
