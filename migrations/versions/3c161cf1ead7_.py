...
Revision ID: 3c161cf1ead7
Revises: 
Create Date: 2023-03-13 18:00:30.599173
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['patient_id'], ['patient.id'], name='fk_drug_patient_id_patient'),
