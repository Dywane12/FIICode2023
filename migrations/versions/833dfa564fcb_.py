...
Revision ID: 833dfa564fcb
Revises: fdac04a0fdfc
Create Date: 2023-03-27 11:26:23.747986
...
revision = '833dfa564fcb'
down_revision = 'fdac04a0fdfc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('doctor', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_doctor_rating')
    ...
    with op.batch_alter_table('patient', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_patient_given_rating')
...
def downgrade():
    ...
    sa.Column('given_rating', sa.INTEGER(), nullable=True),
    ...
    with op.batch_alter_table('patient', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_patient_given_rating', ['given_rating'], unique=False)
    ...
    with op.batch_alter_table('doctor', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_doctor_rating', ['rating'], unique=False)
