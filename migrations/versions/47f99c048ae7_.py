...
Revision ID: 47f99c048ae7
Revises: 502c989484b6
Create Date: 2023-03-20 13:09:24.463697
...
revision = '47f99c048ae7'
down_revision = '502c989484b6'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['doctor_id'], ['patient.doctor_id'], name='fk_consultation_doctor_id_patient'),
