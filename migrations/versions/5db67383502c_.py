...
Revision ID: 5db67383502c
Revises: 3c161cf1ead7
Create Date: 2023-03-13 18:09:31.457015
...
revision = '5db67383502c'
down_revision = '3c161cf1ead7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('patient', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_patient_county')
...
def downgrade():
    ...
    sa.Column('living_age', sa.INTEGER(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_mother')
    )
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_sister')
    )
    ...
    sa.Column('death_age', sa.INTEGER(), nullable=True),
    sa.Column('cause', sa.VARCHAR(length=256), nullable=False),
    sa.ForeignKeyConstraint(['patient_id'], ['family_history.patient_id'], name='fk_grandparent_patient_id_family_history'),
    sa.PrimaryKeyConstraint('patient_id', name='pk_grandparent')
    )
    ...
    sa.Column('postalcode', sa.VARCHAR(length=256), nullable=False),
    sa.Column('city', sa.VARCHAR(length=256), nullable=False),
    sa.Column('county', sa.VARCHAR(length=256), nullable=False),
    sa.Column('passport_id', sa.VARCHAR(length=16), nullable=False),
    ...
    with op.batch_alter_table('patient', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_patient_county', ['county'], unique=False)
    ...
    op.create_table('grandmother',
    sa.Column('patient_id', sa.INTEGER(), nullable=False),
    sa.Column('living', sa.INTEGER(), nullable=True),
    sa.Column('living_age', sa.INTEGER(), nullable=True),
    sa.Column('death_age', sa.INTEGER(), nullable=True),
    sa.Column('cause', sa.VARCHAR(length=256), nullable=False),
    sa.ForeignKeyConstraint(['patient_id'], ['family_history.patient_id'], name='fk_grandmother_patient_id_family_history'),
    sa.PrimaryKeyConstraint('patient_id', name='pk_grandmother')
    )
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_brother')
    )
    ...
    sa.Column('patient_id', sa.INTEGER(), nullable=False),
    sa.Column('is_drinking', sa.INTEGER(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_drinker')
    )
    ...
    sa.Column('blood_type', sa.VARCHAR(length=256), nullable=False),
    sa.ForeignKeyConstraint(['patient_id'], ['patient.id'], name='fk_information_sheet_patient_id_patient'),
    sa.PrimaryKeyConstraint('patient_id', name='pk_information_sheet')
    )
    with op.batch_alter_table('information_sheet', schema=None) as batch_op:
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_father')
    )
    op.create_table('drug',
    sa.Column('patient_id', sa.INTEGER(), nullable=False),
    sa.Column('name', sa.VARCHAR(length=256), nullable=False),
    sa.Column('dosage', sa.VARCHAR(length=256), nullable=False),
    sa.Column('frequency', sa.VARCHAR(length=256), nullable=False),
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_hospitalization')
    )
    ...
    sa.Column('patient_id', sa.INTEGER(), nullable=False),
    sa.Column('is_smoking', sa.INTEGER(), nullable=True),
    sa.Column('was_smoking', sa.INTEGER(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('patient_id', name='pk_smoker')
    )
